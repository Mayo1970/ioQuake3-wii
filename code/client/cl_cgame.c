...
#ifdef CLASSIC
// proto-43 (Dreamcast / Q3 1.16n) event-number translation for the modern
// cgame. The shared table + helpers live in msg.c (Classic_EventToModern &
// friends, declared in qcommon.h) - one source of truth for this client-side
// receive path and the sv_snapshot.c/sv_client.c emit path when hosting.
// The raw retail state (cl.parseEntities / clSnap->ps) must stay untouched
// for delta chaining; only the cgame-facing copies below are translated.
#endif // CLASSIC
