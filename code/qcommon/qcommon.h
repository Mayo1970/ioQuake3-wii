...
#endif	// number of old messages that must be kept on client and
...
#endif			// max string commands buffered for restransmit
...
#endif	// ACK window of 48 download chunks. Cannot set this higher, or clients
